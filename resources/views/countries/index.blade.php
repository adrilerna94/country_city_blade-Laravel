...
<div class="container" style="max-width: 1200px; margin: 20px auto; padding: 20px; background-color: #f4f4f4; border-radius: 5px;">
  ...
  <table style="width: 100%; border-collapse: collapse; margin-top: 20px;">
      <thead>
          <tr>
              <th style="border: 1px solid #ccc; padding: 8px; background-color: #f0f0f0;">Index</th>
              ...
              <!-- Columnas para las acciones de Show, Edit, Delete -->
              <th style="border: 1px solid #ccc; padding: 8px; background-color: #f0f0f0;">Show</th>
              <th style="border: 1px solid #ccc; padding: 8px; background-color: #f0f0f0;">Edit</th>
              <th style="border: 1px solid #ccc; padding: 8px; background-color: #f0f0f0;">Delete</th>
          </tr>
      </thead>
    ...
    @forelse ($countries as $index => $country)
        <tr>
            ...
            <!-- Columna para las acciones (Show, Edit, Delete) -->
            <td style="border: 1px solid #ccc; padding: 8px; text-align: center;">
                <a href="{{ route('countries.show', $country->Code) }}" style="padding: 5px 10px; background-color: #007bff; color: white; text-decoration: none; border-radius: 5px; display: block; margin-bottom: 5px;">
                    Show
                </a>
            </td>
            <td style="border: 1px solid #ccc; padding: 8px; text-align: center;">
                <a href="{{ route('countries.edit', $country->Code) }}" style="padding: 5px 10px; background-color: #ffc107; color: white; text-decoration: none; border-radius: 5px; display: block; margin-bottom: 5px;">
                    Edit
                </a>
            </td>
            <td style="border: 1px solid #ccc; padding: 8px; text-align: center;">
    ...
    @empty
        <tr>
            <td colspan="18" style="text-align: center; padding: 15px;">There is no data.</td>
        </tr>
    @endforelse
    </tbody>
